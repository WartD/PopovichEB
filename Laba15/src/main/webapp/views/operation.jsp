                ...
                <table class="table">
                    ...
                    <c:forEach var="op" items="${operations}">
                        <tr>
                            ...
                            <td width="20"><a href="<c:url value="/editoperation?id=${op.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Редактировать"
                                     src="img/edit.png"></a>
                            </td>
                            <td width="20"><a href="<c:url value="/deleteoperation?id=${op.getId()}"/>" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Удалить"
                                     src="img/delete.png" onclick="return confirm('Удалить операцию с ID: ' +${op.getId()} + '?')"></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <div class="col-4 border px-4 a-color">
                <form method="POST" action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select name="subAccount" class="form-control">
