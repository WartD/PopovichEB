                ...
                <table class="table">
                    ...
                    <c:forEach var="accounts" items="${accounts}">
                        <tr>
                            ...
                            <td width="20"><a href="<c:url value="/editaccount?id=${accounts.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Редактировать"
                                     src="img/edit.png"></a>
                            </td>
                            <td width="20"><a href="<c:url value="/deleteaccount?id=${accounts.getId()}"/>" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Удалить"
                                     src="img/delete.png" onclick="return confirm('Удалить план счетов с ID: ' +${accounts.getId()} + '?')"></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
