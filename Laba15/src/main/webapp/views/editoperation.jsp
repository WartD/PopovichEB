        ...
        <div class="row justify-content-start ">
            <div class="col-8 border bg-light px-4">
                ...
                <table class="table">
                    ...
                    <c:forEach var="op" items="${operations}">
                        <tr>
                            <td>${op.getId()}</td>
                            <td>${op.getDeal().getAgreement()}</td>
                            <td>${op.getSubAccount().getName()}</td>
                            <td>${op.getNumber()}</td>
                            <td>${op.getData()}</td>
                            <td>${op.getType()}</td>
                            <td>${op.getSum()}</td>
            ...
            <div class="col-4 border px-4 a-color">
                <form method="POST" action="">
                    <h3 class="a-color">Редактировать операцию:</h3>
                    <div class="mb-3 row">
                        <label for="idop"
                               class="col-sm-3 col-form-label a-color">Код операции</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" readonly id="idop" value="${operationEdit.getId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="deal"
                        ...
                        <div class="col-sm-6">
                            <select name="dealField" class="form-control">
                                <option value="${operationEdit.deal}">${operationEdit.deal.getAgreement()}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <select name="subField" class="form-control">
                                <option value="${operationEdit.subAccount}">${operationEdit.subAccount.getName()}</option>
                                <c:forEach var="sub" items="${subAccounts}">
                                    <option value="${sub}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="number"
                                   class="form-control" id="inputNumber" value="${operationEdit.getNumber()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputDate"
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="date"
                                   class="form-control" id="inputDate" value="${operationEdit.getData()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputType"
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="type"
                                   class="form-control" id="inputType" value="${operationEdit.getType()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="inputSum"
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="sum"
                                   class="form-control" id="inputSum" value="${operationEdit.getSum()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="saldoInput"
                                   class="form-control" id="inputSaldo" value="${operationEdit.getSaldoInput()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="saldoOutput"
                                   class="form-control" id="outputSaldo" value="${operationEdit.getSaldoOutput()}"/>
                        </div>
                    </div>
                    <p>
                        <br> <br> <br>
                        ...
                        <a href='<c:url value="/operation" />' role="button" class="btn btn-secondary">Отменить</a>
                        <br>
                    </p>
                </form>
            </div>
