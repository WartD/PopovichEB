                ...
                <table class="table">
                    ...
                    <c:forEach var="sub" items="${subAccounts}">
                        <tr>
                            ...
                            <td>${sub.getName()}</td>
                            <td>${sub.getNumber()}</td>
                            <td width="20"><a href="<c:url value="/editsubaccount?id=${sub.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Редактировать"
                                     src="img/edit.png"></a>
                            </td>
                            <td width="20"><a href="<c:url value="/deletesubaccount?id=${sub.getId()}"/>" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Удалить"
                                     src="img/delete.png" onclick="return confirm('Удалить субсчет с ID: ' +${sub.getId()} + '?')"></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
