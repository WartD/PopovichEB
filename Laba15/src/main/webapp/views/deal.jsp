                ...
                <table class="table">
                    ...
                    <c:forEach var="deal" items="${deals}">
                        <tr>
                            ...
                            <td width="20"><a href="<c:url value="/editdeal?id=${deal.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Редактировать"
                                     src="img/edit.png"></a>
                            </td>
                            <td width="20"><a href="<c:url value="/deletedeal?id=${deal.getId()}"/>" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Удалить"
                                     src="img/delete.png" onclick="return confirm('Удалить сделку с ID: ' +${deal.getId()} + '?')"></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
